...
import {LotteryLevelManageDialogComponent} from "../lottery-level-manage-dialog/lottery-level-manage-dialog.component";

@Component({
  selector: 'app-update-lottery-dialog',
  templateUrl: './update-lottery-dialog.component.html',
  styleUrls: ['./update-lottery-dialog.component.css'],
  providers:[LotteryLevelService,LotteryService]
})
export class UpdateLotteryDialogComponent implements OnInit {
  action:string;
  ...
  constructor(@Inject(MD_DIALOG_DATA) public dialogData:any,
              ...
              public dialogRef:MdDialogRef<UpdateLotteryDialogComponent>,
  ...
  toSetLotteryLevel(){
    let lotteryLevelManageDialogRef=this.dialog.open(LotteryLevelManageDialogComponent,{
    ...
    lotteryLevelManageDialogRef.afterClosed().subscribe(result=>{
      if(!!result){
